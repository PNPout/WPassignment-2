        ...
        <div class="header__wrapper px-6 py-4 px-lg-10 py-lg-8 py-md-6 d-flex flex-row justify-content-between align-items-center">
            <div class="header-left d-flex gap-9 justify-content-start">
                ...
                <div class="header-left__navbar navbar d-md-flex d-lg-none">
                    <button class="header-left__navbar-toggle navbar-toggler border border-0 p-0 bg-transparent" type="button" data-bs-toggle="offcanvas" data-bs-target="#headerOffcanvas" aria-controls="headerOffcanvas" aria-label="Toggle navigation">
                ...
                <a href="{{ home_url('/') }}" title="Go to homepage"><img src="@asset('./images/logo.svg')" alt="Logo of Followed Text" class="header-left__logo" /></a>

            </div>

            <div class="header-right">
                <nav class="header-right-nav d-flex flex-lg-row flex-column  offcanvas-lg offcanvas-start" id="headerOffcanvas" role="navigation">
                    <div class="header-offcanvas d-flex d-lg-none flex-row gap-6 px-6 py-9 align-items-center border border-peach">
                        <button type="button" class="header-offcanvas__close btn-close btn-close-white d-flex d-lg-none p-0 border border-0 bg-transparent" data-bs-dismiss="offcanvas" data-bs-target="#headerOffcanvas" aria-label="Close offcanvas menu">
