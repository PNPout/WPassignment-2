...
<header class="header">
  <div class="header__container container p-0 d-flex flex-row justify-content-between align-items-center">
    <div class="header__wrapper px-6 py-4">
      <div class="header-left d-flex gap-8 justify-content-start">
      ...
      <div class="header-right">
        <nav class="header-right-nav d-flex flex-lg-row flex-column  offcanvas-lg offcanvas-start bg-primary" id="offcanvasResponsive" role="navigation">
          ...
          <ul class="header-right-nav__list d-flex flex-lg-row flex-column px-10 py-11 h-100 align-items-center justify-content-center gap-10 list-unstyled">
            <li class="header-right-nav__item h6 mb-0 text-capitalize">
              <a href="#" class="header-right-nav__link text-white " aria-label="Read about our company">About</a>
            </li>
            <li class="header-right-nav__item h6 mb-0 text-capitalize">
              <a href="#" class="header-right-nav__link text-white " aria-label="Read our blog">Blog</a>
            </li>
            <li class="header-right-nav__item h6 mb-0 text-capitalize">
              <a href="#" class="header-right-nav__link text-white" aria-label="Know more about our team">Team</a>
            </li>
            <li class="header-right-nav__item h6 mb-0 text-capitalize">
              <a href="#" class="header-right-nav__link text-white" aria-label="Explore career with us">Career</a>
            </li>
            <li class="header-right-nav__item h6 mb-0 text-capitalize">
              <a href="#" class="header-right-nav__link text-white" aria-label="Contact us">Contact</a>
            </li>
          </ul>
        </nav>
