            ...
            <div class="row g-6 g-md-10">
                ...
                <div class="col-lg-8 d-none d-md-flex">
                    <div class="hero-block__content bg-white p-6 p-lg-8 border-success">
                        ...
                        <a href="#" class="button button__border button__with-icon mt-4 mt-lg-6" title="Contact us">Contact Us<span class="button__icon"><svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-4 d-none d-lg-flex"><img src="@asset('./images/hero-3.jpg')" alt="hero 3" class="hero-block__img hero-block__img--third"></div>
            </div>
        </div>
    </div>
</section>