...
<section class="about-us-b">
  <div class="about__wrapper">
    <div class="about__content">
      ...
      <a href="#" class="about__button button__fill button__with-icon">Learn More<span class="button__icon"><svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="about__image-section">
      ...
      <div class="about__image-wrapper">
        <img loading="lazy" src="@asset('images/about-image.jpg')" style="width:100%;height:auto;" alt="Picture of Van in desert" class="about__image">
